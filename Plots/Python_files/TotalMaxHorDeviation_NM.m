...
opts = detectImportOptions('TotalMaxHorDeviation_NM.csv');
data = readtable('TotalMaxHorDeviation_NM.csv', opts);
...
xticklabels({'NCW', 'SSD'});
xlim([0.2, 2.8]);
ylabel('Max Horizontal Deviation (NM)', 'FontWeight', 'bold', 'FontSize', 17);
