...
opts = detectImportOptions('TotalDisplayChanges.csv');
data = readtable('TotalDisplayChanges.csv', opts);
...
xticklabels({'NCW', 'SSD'});
xlim([0.2, 2.8]);
ylabel('Number of Display Triggers', 'FontWeight', 'bold', 'FontSize', 17);
